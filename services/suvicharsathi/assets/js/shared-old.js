// Injects the shared header and footer into the pag  const footerHTML = `
...
function handleLogout() {
  ...
  if (isAuthenticated) {
    ...
    navItems += `
      <li class="nav-item"><a class="nav-link fw-semibold" href="login.html">Login</a></li>
      <li class="nav-item"><a class="nav-link fw-semibold btn btn-outline-light ms-2" href="register.html">Register</a></li>
    `;
  }
