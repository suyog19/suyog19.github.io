...
class PerformanceContractTests(unittest.TestCase):
    ...
    def test_accepts_scoped_assets_and_deferred_survey(self) -> None:
        ...
        self.write("card/index.html", '<link rel="stylesheet" href="../css/card.css">')
        self.write(
    ...
    def test_rejects_card_css_on_unrelated_page(self) -> None:
        self.write("about/index.html", '<link rel="stylesheet" href="../css/card.css">')
        self.assertTrue(any("card stylesheet escaped /card/" in error for error in validate(self.root)))
